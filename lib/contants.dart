...
const PrimaryColorL = Color(0xFF0D8E53);
...
const PrimaryColorD = Color(0xFF0D8E53);
const BackgroundColorD = Color(0xFFFCFCFC);
const InactiveChartColorD = Color(0xFFEAECEF);
